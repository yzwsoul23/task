...
l1rect = pygame.draw.lines(screen, GOLD, True, plist, 2) #画线
a1rect = pygame.draw.arc(screen, RED, (200,220,200,100), 1.4*pi, 1.9*pi, 3) #画弧(左端x：50,上端y：50,宽：500,高：300),取头段1.4*pi,取尾段1.9*pi,线粗3)
